...
export interface InvestorDirectoryHeroProps {
  className?: string;
}

const InvestorDirectoryHero: React.FC<InvestorDirectoryHeroProps> = ({ className }) => {
  return (
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Text
            variant="h1"
            as="h1"
            className="text-5xl lg:text-6xl font-bold font-display mb-6 bg-linear-to-r from-[#1A1A1A] via-[#D4AF37] to-[#1A1A1A] bg-clip-text text-transparent"
          >
            Connect with Visionary Investors
          </Text>
          ...
          >
            Discover verified investors across industries, countries, and investment ranges.
            Build partnerships that bring groundbreaking innovations to life.
          </Text>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={index}
                className="p-6 rounded-[20px] bg-linear-to-br from-[#FFF8F0] to-white"
